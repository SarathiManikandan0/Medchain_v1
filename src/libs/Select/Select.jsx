...
import { ReactComponent as Down } from "../../libs/icons/down_arrow.svg"

//value props should be a string in case of single values and a array of string in case multiSelect

const Select = ({ isSearchable = false, options, value, onChange, showDropDownIndicator = true, iconName, isMulti = false, className }) => {
  ...
  return (
    <div className={`${styles.select_container} ${className ? className : ""}`} ref={optionsRef}>
      ...
      >
        ...
        {showDropDownIndicator && <Down name="down" size={20} rotate={openOptions ? 180 : 0} />}
      </div>
      {openOptions && (
